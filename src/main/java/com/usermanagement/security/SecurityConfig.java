    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/**", "/user/**", "/h2-console/**","/v3/api-docs/**","/swagger-ui/**","/swagger-ui.html","/v3/api-docs.yaml","/items/**","/backend-running","/auth/forgot-password","/auth/verify-otp","/auth/reset-password","/api/reports/**").permitAll()
